...
const WOW_CLASS_COLORS: Readonly<Record<string, string>> = {
  'Death Knight': '#C41E3A',
  'Demon Hunter': '#A330C9',
  Druid: '#FF7C0A',
  Evoker: '#33937F',
...
export function wowClassColor(wowClass: string | null | undefined): string {
  return WOW_CLASS_COLORS[wowClass ?? ''] ?? '#E5E7EB'
}
